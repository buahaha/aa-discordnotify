...
from discordproxy.discord_api_pb2 import SendDirectMessageRequest, Embed
...
@shared_task
def forward_notification_to_discord_user(notification_id):
    ...
    with grpc.insecure_channel("localhost:50051") as channel:
        ...
        request = SendDirectMessageRequest(user_id=discord_user_id, embed=embed)
